    ...
    public partial class adddata : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2024, 5, 3, 21, 16, 44, 989, DateTimeKind.Local).AddTicks(7260), 1, "Action" });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "CreatedDateTime", "DisplayOrder", "Name" },
                values: new object[] { 2, new DateTime(2024, 5, 3, 21, 16, 44, 989, DateTimeKind.Local).AddTicks(7270), 2, "SciFi" });

            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "CreatedDateTime", "DisplayOrder", "Name" },
                values: new object[] { 3, new DateTime(2024, 5, 3, 21, 16, 44, 989, DateTimeKind.Local).AddTicks(7270), 3, "History" });
