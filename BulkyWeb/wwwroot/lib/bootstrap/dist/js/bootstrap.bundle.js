...
(function (global, factory) {
  ...
  const getSelector = element => {
    ...
    if (!selector || selector === '#') {
      ...
      // See https://github.com/twbs/bootstrap/issues/32263
  ...
  function getTrueOffsetParent(element) {
    if (!isHTMLElement(element) || // https://github.com/popperjs/popper-core/issues/836
  ...
  */
  ...
  function getCompositeRect(elementOrVirtualElement, offsetParent, isFixed) {
    ...
    if (isOffsetParentAnElement || !isOffsetParentAnElement && !isFixed) {
      if (getNodeName(offsetParent) !== 'body' || // https://github.com/popperjs/popper-core/issues/1068
  ...
  class FocusTrap {
    ...
    _getConfig(config) {
      ...
      typeCheckConfig(NAME$6, config, DefaultType$6);
      return config;
    }
   ...
   *
   * Shoutout to Angular 6 https://github.com/angular/angular/blob/6.2.4/packages/core/src/sanitization/url_sanitizer.ts
   */
